...
const CommentsBox = React.memo(({ publication, setIsOnBoxComments, currentUser, currentUserData, ownerId }) => {
  ...
  const handleFileChange = (e) => {
    ...
    if (!file.type.startsWith("image/")) {
      messageError("Solo se permiten imágenes");
      return;
    }
  ...
  const createdComment = async () => {
    ...
    try {
      ...
      // Se actualiza la publicación correspondiente agregando el nuevo comentario
